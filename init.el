...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (disaster flycheck-irony company-irony irony evil-matchit py-isort yapfify company-quickhelp cargo toml-mode helm-dash counsel-dash esup evil-iedit-state iedit fringe-helper git-gutter company-racer racer flycheck-rust rust-mode rainbow-delimiters evil-nerd-commenter zenburn-theme spaceline spaceline-config pyvenv pyenv-mode flycheck-pos-tip flycheck counsel-projectile projectile beacon smart-mode-line rainbow-mode haml-mode company-web web-mode exec-path-from-shell coffee-mode rjsx-mode rsjx-mode company-tern tern xref-js2 js2-mode pip-requirements gitconfig-mode gitignore-mode which-key volatile-highlights company-anaconda anaconda-mode smartparens-config all-the-icons neotree counsel ivy smartparens company evil-window ace-window avy evil-magit evil-leader magit use-package evil))))
(custom-set-faces
